 ...
 */
public class ProperGoodsPageFFTest {
    ...
    public void checkMainAndConcreteGoodsPages() {
        ...
        for (int i = 0; i < webElements.size(); i++) {
            ...
            Assert.assertEquals("rgb(119, 119, 119)", regularPriceColor);
            Assert.assertEquals("line-through", regularPriceStrike);

            Assert.assertEquals("rgb(204, 0, 0)", campaignPriceColor);
            ...
            Assert.assertEquals("rgb(102, 102, 102)", regularPriceColor);
            Assert.assertEquals("line-through", regularPriceStrike);
